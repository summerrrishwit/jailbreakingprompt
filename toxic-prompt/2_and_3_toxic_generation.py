...
# class VivoAPIModel(torch.nn.Module):
#     APP_ID = '0599323503'
#     APP_KEY = 'ZTluHGficaycuHPV'
#     URI = '/chatgpt/completions'
#     DOMAIN = 'chatgpt-api.vivo.lan:8080'
#
#     def __init__(self, model_name='vivo-BlueLM-TB-Pro', provider='vivo'):
#         super().__init__()
#         self.model_name = model_name
#         self.provider = provider
#         # Fake config to satisfy openprompt
#         self.config = type('Config', (), {'architectures': ['VivoAPI'], 'model_type': 'vivo'})()
#
...
#
#     def get_gpt_answer(self, prompt):
#         import requests
#         import uuid
#         import time
#         import traceback
...
#                 else:
#                     print(f'【{self.model_name} try {i+1} error')
...
#         raise NotImplementedError("API Model does not support training/forward pass.")
#
#     def generate(self, inputs, **kwargs):
#         # Need to decode inputs back to string if they are token ids, or handle text directly
#         return [self.get_gpt_answer("prompt_placeholder")] # Placeholder
