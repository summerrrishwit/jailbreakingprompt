...
# class VivoAPIWorker(object):
#     APP_ID = '0599323503'
#     APP_KEY = 'ZTluHGficaycuHPV'
#     URI = '/chatgpt/completions'
#     DOMAIN = 'chatgpt-api.vivo.lan:8080'
#
#     def __init__(self, model_path, tokenizer, conv_template, device):
...
#
#     def get_gpt_answer(self, prompt, model='vivo-BlueLM-TB-Pro', provider='vivo'):
#         import requests
#         import uuid
#         import time
#         import traceback
